...
class _CrearAnuncioScreenState extends State<CrearAnuncioScreen> {
                        ...
                        children: [
                          ...
                          TextField(
                            decoration: InputDecoration(
                                ...
                                hintText: 'Introduce un titulo para el anuncio'
                            ),
                          ),
                        ],
                      ),
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintText: 'Introduce el año del turismo'
                            ),
                          )],
                      ),
                    ),
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintText: 'Introduce los kilometros del turismo'
                            ),
                          )],
                      ),
                    ),
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintText: 'Introduce los cc del turismo'
                            ),
                          )],
                      ),
                    ),
  ...
  uploadImages() {
    images.forEach((item) async {
      final filePath = await FlutterAbsolutePath.getAbsolutePath(item.identifier);

      File tempFile = File(filePath);
      if (tempFile.existsSync()) {
        imagesInFile.add(tempFile);
      }
    });
    FirebaseStorage storage = FirebaseStorage.instance;
    Reference ref =
    storage.ref().child("addcarimage/image1" + DateTime.now().toString());
    UploadTask uploadTask = ref.putFile(imagesInFile[0]);
